/*
name=[translation].[p_insertOrUpdateTowaryFromFractus2]
version=1.0.1
lastUpdate=2017-01-24 10:37:21
yb/zK2+XbPrCUU0Bp6Wk2A==
*/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[translation].[p_insertOrUpdateTowaryFromFractus2]') AND type in (N'P', N'PC'))
DROP PROCEDURE [translation].[p_insertOrUpdateTowaryFromFractus2]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[translation].[p_insertOrUpdateTowaryFromFractus2]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [translation].[p_insertOrUpdateTowaryFromFractus2]
