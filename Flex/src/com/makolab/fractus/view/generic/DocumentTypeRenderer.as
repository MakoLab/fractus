package com.makolab.fractus.view.generic
{
	...
	public class DocumentTypeRenderer extends UIComponent implements IDropInListItemRenderer, IListItemRenderer, IFactory
	{ 
		...
		{
			return new DocumentTypeRenderer();
		}

		public function DocumentTypeRenderer()
		{
			super();
			img = new Image();
			lbl = new Label();
		...
		protected override function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void
		{
			...
			public function set dataObject(value:Object):void
			{
				...
				_dataObject = value;
				if (!cache) buildCache();
				var item:Object = cache[String(_dataObject)];
				if (item)
				{
					img.source = item.icon;
					lbl.text = item.symbol;
