package com.makolab.fractus.commands
{
	...
	public class GetMessageForContractorCommand extends ExecuteCustomProcedureCommand  implements IDocumentSearchCommand
	{
		...
		public function GetMessageForContractorCommand(contractorId:String= null, dateFrom:String=null, dateTo:String = null )
		{
			objectId = contractorId;
			dateFrom =dateFrom;
			dateTo = dateTo;
			super('custom.p_PrestaGetCustomerMessages');
		}
