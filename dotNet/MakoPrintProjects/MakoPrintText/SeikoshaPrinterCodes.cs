...
{
    public class SeikoshaPrinterCodes : PrinterCodes
    {
        ...
        public static Dictionary<string, string> codes = new Dictionary<string, string>
        {
            ...
            {"%PRINTER-FONT-SIZE%default_on", ((char)27).ToString() + ((char)80).ToString()},
            ...
            {"%PRINTER-FONT-SIZE%15.0cpi_on", ((char)27).ToString() + ((char)80).ToString() + ((char)27).ToString() + ((char)115).ToString()},
            {"%PRINTER-FONT-SIZE%15.0cpi_off", ((char)27).ToString() + ((char)80).ToString() + ((char)27).ToString() + ((char)115).ToString() + ((char)1).ToString()},
            {"%PRINTER-FONT-SIZE%17.0cpi_on", ((char)27).ToString() + ((char)80).ToString() + ((char)15).ToString()},
            {"%PRINTER-FONT-SIZE%17.0cpi_off", ((char)27).ToString() + ((char)80).ToString() + ((char)18).ToString()},
            {"%PRINTER-FONT-SIZE%20.0cpi_on", ((char)27).ToString() + ((char)77).ToString() + ((char)15).ToString()},
            {"%PRINTER-FONT-SIZE%20.0cpi_off", ((char)27).ToString() + ((char)80).ToString() + ((char)18).ToString()},
            {"%PRINTER-INTERLINIA%6", ((char)27).ToString() + ((char)65).ToString() + ((char)12).ToString()},
            {"%PRINTER-INTERLINIA%8", ((char)27).ToString() + ((char)65).ToString() + ((char)9).ToString()},
            {"%PRINTER-INTERLINIA%10", ((char)27).ToString() + ((char)65).ToString() + ((char)7).ToString()},
            {"%PRINTER-INTERLINIA%12", ((char)27).ToString() + ((char)65).ToString() + ((char)6).ToString()},
