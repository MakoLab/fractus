...
namespace Makolab.Printing.Text
{
    ...
    public class RawPrinterHelper
    {
        ...
        public static bool SendBytesToPrinter(string szPrinterName, IntPtr pBytes, Int32 dwCount)
        {
            ...
            di.pDocName = "Wydruk z Fractusa 2";
            di.pDataType = "RAW";

            //int x = OpenPrinter(szPrinterName.Normalize(), out hPrinter, ref pd);
            //if (true)
            ...
            if (bSuccess == false)
            {
                ...
                if (dwError == 1801) throw new TextPrinterException(TextExceptionId.PrinterNameError);
                else throw new Win32Exception(dwError);
            }
            //Console.WriteLine("Wynik drukowania=" + bSuccess);
            return bSuccess;
        }
