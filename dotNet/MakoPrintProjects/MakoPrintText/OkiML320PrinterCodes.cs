...
{
    public class OkiML320PrinterCodes : PrinterCodes
    {
        public static Dictionary<string, string> codes = new Dictionary<string, string>
        {
            ...
            {"%PRINTER-FONT-SIZE%10.0cpi_on", ((char)14).ToString()},
            {"%PRINTER-FONT-SIZE%10.0cpi_off", ((char)20).ToString()},
        ...
        public override string ReplaceChars(string tekst)
        {
            ...
            b.Replace("%FONT-WEIGHT%bold_on", codes["%PRINTER-FONT-WEIGHT%bold_on"])
             ...
             .Replace("%FONT-SIZE%6.0pt_on", codes["%PRINTER-FONT-SIZE%10.0cpi_on"])
             .Replace("%FONT-SIZE%6.0pt_off", codes["%PRINTER-FONT-SIZE%10.0cpi_off"])

             .Replace("%FONT-SIZE%8.0pt_on", codes["%PRINTER-FONT-SIZE%10.0cpi_on"])
             .Replace("%FONT-SIZE%8.0pt_off", codes["%PRINTER-FONT-SIZE%10.0cpi_off"])

             .Replace("%FONT-SIZE%10.0pt_on", codes["%PRINTER-FONT-SIZE%10.0cpi_on"])
             .Replace("%FONT-SIZE%10.0pt_off", codes["%PRINTER-FONT-SIZE%10.0cpi_off"])

             .Replace("%FONT-SIZE%12.0pt_on", codes["%PRINTER-FONT-SIZE%10.0cpi_on"])
             .Replace("%FONT-SIZE%12.0pt_off", codes["%PRINTER-FONT-SIZE%10.0cpi_off"])

             .Replace("%FONT-SIZE%14.0pt_on", codes["%PRINTER-FONT-SIZE%10.0cpi_on"])
             .Replace("%FONT-SIZE%14.0pt_off", codes["%PRINTER-FONT-SIZE%10.0cpi_off"])
             ...
             .Replace("%FONT-SIZE%20.0pt_off", codes["%PRINTER-FONT-SIZE%10.0cpi_on"])
