...
{
    /// <summary>
    /// Class representing an accounting journal (dictionary entry).
    /// </summary>
    [XmlSerializable(XmlField = "accountingJournal")]
    [DatabaseMapping(TableName = "accountingJournal")]
    internal class AccountingJournal : BusinessObject, ILabeledDictionaryBusinessObject, IVersionedBusinessObject, IOrderable
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets <see cref="AccountingJournal"/>'s symbol. Cannot be null or <see cref="String.Empty"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets <see cref="AccountingJournal"/>'s label. Cannot be null.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountingJournal"/> class with a specified xml root element.
        /// </summary>
        public AccountingJournal()
            : base(null, BusinessObjectType.AccountingJournal)
        {
