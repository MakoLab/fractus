...
{
    /// <summary>
    /// Class representing an accounting rule (dictionary entry).
    /// </summary>
    [XmlSerializable(XmlField = "accountingRule")]
    [DatabaseMapping(TableName = "accountingRule")]
    internal class AccountingRule : BusinessObject, ILabeledDictionaryBusinessObject, IVersionedBusinessObject, IOrderable
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets <see cref="AccountingRule"/>'s symbol. Cannot be null or <see cref="String.Empty"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets <see cref="AccountingRule"/>'s label. Cannot be null.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountingRule"/> class with a specified xml root element.
        /// </summary>
        public AccountingRule()
            : base(null, BusinessObjectType.AccountingRule)
        {
