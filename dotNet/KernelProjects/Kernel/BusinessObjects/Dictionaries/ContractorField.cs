...
{
    /// <summary>
    /// Class representing a contractor field (dictionary entry).
    /// </summary>
    [XmlSerializable(XmlField = "contractorField")]
    [DatabaseMapping(TableName = "contractorField")]
    internal class ContractorField : BusinessObject, ILabeledDictionaryBusinessObject, IVersionedBusinessObject, IOrderable
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets <see cref="ContractorField"/>'s name.
        /// </summary>
        ...
        /// Gets <see cref="ContractorField"/>'s name.
        /// </summary>
        public ContractorFieldName TypeName
        {
            get
            {
                string[] typeNames = Enum.GetNames(typeof(ContractorFieldName));
                ...
                {
                    if (name == currentName)
                        return (ContractorFieldName)Enum.Parse(typeof(ContractorFieldName), currentName);
                }

                return ContractorFieldName.Unknown;
            }
        }

        /// <summary>
        /// Gets or sets <see cref="ContractorField"/>'s label. Cannot be null.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets <see cref="ContractorField"/>'s metadata. Cannot be null.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContractorField"/> class with a specified xml root element.
        /// </summary>
        public ContractorField()
            : base(null, BusinessObjectType.ContractorField)
        {
