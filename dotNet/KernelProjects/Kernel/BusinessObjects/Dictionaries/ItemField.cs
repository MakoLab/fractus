...
{
    /// <summary>
    /// Class representing an item field (dictionary entry).
    /// </summary>
    [XmlSerializable(XmlField = "itemField")]
    [DatabaseMapping(TableName = "itemField")]
    internal class ItemField : BusinessObject, ILabeledDictionaryBusinessObject, IVersionedBusinessObject, IOrderable
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets <see cref="ItemField"/>'s name.
        /// </summary>
        ...
        /// Gets <see cref="ItemField"/>'s name.
        /// </summary>
        public ItemFieldName TypeName
        {
            get
            {
                string[] typeNames = Enum.GetNames(typeof(ItemFieldName));

                foreach (string name in typeNames)
                {
                    if (name == this.Name)
                        return (ItemFieldName)Enum.Parse(typeof(ItemFieldName), this.Name);
                }

                return ItemFieldName.Unknown;
            }
        }

        /// <summary>
        /// Gets or sets <see cref="ItemField"/>'s label. Cannot be null.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets <see cref="ItemField"/>'s metadata. Cannot be null.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemField"/> class with a specified xml root element.
        /// </summary>
        public ItemField()
            : base(null, BusinessObjectType.ItemField)
        {
