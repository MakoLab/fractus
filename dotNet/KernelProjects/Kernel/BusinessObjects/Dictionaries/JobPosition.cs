...
{
    /// <summary>
    /// Class representing a job position (dictionary entry).
    /// </summary>
    [XmlSerializable(XmlField = "jobPosition")]
    [DatabaseMapping(TableName = "jobPosition")]
    internal class JobPosition : BusinessObject, ILabeledDictionaryBusinessObject, IVersionedBusinessObject, IOrderable
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JobPosition"/> class with a specified xml root element.
        /// </summary>
        public JobPosition()
            : base(null, BusinessObjectType.JobPosition)
        {
