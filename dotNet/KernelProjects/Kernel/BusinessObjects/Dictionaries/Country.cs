...
namespace Makolab.Fractus.Kernel.BusinessObjects.Dictionaries
{
    ...
    /// </summary>
    [XmlSerializable(XmlField = "country")]
    [DatabaseMapping(TableName = "country")]
    internal class Country : BusinessObject, ILabeledDictionaryBusinessObject, IVersionedBusinessObject, IOrderable
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets <see cref="Country"/>'s symbol. Cannot be null or <see cref="String.Empty"/>.
        /// </summary>
        ...
        /// </summary>
        public Country()
            : base(null, BusinessObjectType.Country)
        {
