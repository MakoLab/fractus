...
{
    /// <summary>
    /// Class representing a company (dictionary entry).
    /// </summary>
    [XmlSerializable(XmlField = "company")]
    [DatabaseMapping(TableName = "company")]
    internal class Company : BusinessObject, ILabeledDictionaryBusinessObject, IVersionedBusinessObject, IOrderable
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets <see cref="Company"/>'s label. Cannot be null.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Company"/> class with a specified xml root element.
        /// </summary>
        public Company()
            : base(null, BusinessObjectType.Company)
        {
