...
{
    internal class ServiceOrderTypeOptions
    {
        ...
        public CalculationType CalculationType
        {
            get
            {
                string type = this.documentType.Options.Element("serviceOrder").Attribute("calculationType").Value;
        ...
        public bool AllowCalculationTypeChange
        {
            get
            {
                string val = this.documentType.Options.Element("serviceOrder").Attribute("allowCalculationTypeChange").Value;
        ...
        public SummationType SummationType
        {
            get
            {
                string type = this.documentType.Options.Element("serviceOrder").Attribute("summationType").Value;
        ...
        public bool AllowOtherCurrencies
        {
            get
            {
                string val = this.documentType.Options.Element("serviceOrder").Attribute("allowOtherCurrencies").Value;
                return Convert.ToBoolean(val, CultureInfo.InvariantCulture);
            }
        }
        ...
        public bool AllowMultiplePositions
        {
            get
            {
                string val = this.documentType.Options.Element("serviceOrder").Attribute("allowMultiplePositions").Value;
                return Convert.ToBoolean(val, CultureInfo.InvariantCulture);
            }
        }
        ...
        public Optionality ContractorOptionality
        {
            get
            {
                string type = this.documentType.Options.Element("serviceOrder").Attribute("contractorOptionality").Value;
        ...
        public bool AllowIssuingPersonChange
        {
            get
            {
                string val = this.documentType.Options.Element("serviceOrder").Attribute("allowIssuingPersonChange").Value;
                return Convert.ToBoolean(val, CultureInfo.InvariantCulture);
            }
        }
        ...
        public XElement DocumentFeatures
        {
            get
            {
                return this.documentType.Options.Element("serviceOrder").Element("documentFeatures");
            }
        }

        public ServiceOrderTypeOptions(DocumentType documentType)
        {
