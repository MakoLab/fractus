...
namespace OrderTrackerGUI
{
    public class DatabaseHelper
    {
        ...
        public DatabaseHelper(DatabaseRepository repository)
        {
        ...
        {
            SqlConnection conn = this.repository.GetOpenedConnection();
        ...
        {
            using(SqlConnection conn = this.repository.GetOpenedConnection())
            using (SqlCommand cmd = new SqlCommand(procedure, conn))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddRange(sqlParameters);
        ...
        { 
            var conn =  this.repository.GetOpenedConnection();
