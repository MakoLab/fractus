...
namespace Makolab.Fractus.SalesOrderTracker
{
    public class DatabaseHelper
    {
        ...
        {
            SqlConnection conn = this.GetOpenedConnection();
            try
            {
        ...
        {
            using(SqlConnection conn = this.GetOpenedConnection())
            using (SqlCommand cmd = new SqlCommand(procedure, conn))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddRange(sqlParameters);
        ...
        { 
            var conn =  this.GetOpenedConnection();
