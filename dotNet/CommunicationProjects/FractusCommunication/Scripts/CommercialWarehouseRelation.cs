...
{
    /// <summary>
    /// Process CommercialWarehouseRelation communication package.
    /// </summary>
    public class CommercialWarehouseRelation : SnapshotScript
    {
        /// <summary>
        /// Document repository
        /// </summary>
        ...
        {
            get { return "commercialWarehouseRelation"; }
        }
        ...
        {
            DBXml snapshot = this.repository.FindCommercialWarehouseRelations(relationsId);
            return GetSnapshotOrNull(snapshot);              
        }
