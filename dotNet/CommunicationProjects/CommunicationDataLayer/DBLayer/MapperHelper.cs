namespace Makolab.Fractus.Communication.DBLayer
{
    ...
    public class MapperHelper
    {
        ...
        public IDatabaseConnectionManager Database { get; set; }
        ...
        {
            SqlCommand cmd = this.Database.CreateMethodScopedSqlCommand();
            cmd.Transaction = this.mapper.Transaction as SqlTransaction;
